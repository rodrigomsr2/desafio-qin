...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ErrorDetails> handleGuestNotFoundException(GuestNotFoundException ex, WebRequest request) {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        return buildResponseEntity(new ErrorDetails(OffsetDateTime.now(), error, ex.getLocalizedMessage()), BAD_REQUEST);
    }
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        return buildResponseEntity(new ErrorDetails(OffsetDateTime.now(), builder.substring(0, builder.length() - 2), ex.getLocalizedMessage()), UNSUPPORTED_MEDIA_TYPE);
    }
